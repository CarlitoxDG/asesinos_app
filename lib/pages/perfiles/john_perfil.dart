...
class JohnPerfil extends StatefulWidget {
  const JohnPerfil({super.key});

  @override
  State<JohnPerfil> createState() => _JohnPerfilState();
}

class _JohnPerfilState extends State<JohnPerfil> {
  @override
